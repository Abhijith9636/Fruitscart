...
class fruitsdetail4 extends StatefulWidget {
  const fruitsdetail4({super.key});

  @override
  State<fruitsdetail4> createState() => _fruitsdetail4State();
}

class _fruitsdetail4State extends State<fruitsdetail4> {
  @override
  Widget build(BuildContext context) {
  return Scaffold(

       appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 235, 126, 11),
        toolbarHeight: 80,
      ...
      Stack(
        children: [
          Container(
            ...
            decoration: BoxDecoration(color:Color.fromARGB(255, 235, 126, 11),borderRadius: BorderRadius.only(bottomLeft: Radius.circular(30),bottomRight: Radius.circular(30))),
        ...
        child: Padding(
          ...
          child: Column(
           ...
           children: [
            ...
            Image(image: AssetImage("assets2/mango2.png",),height: 300, width: 400,),
          
            Row(
               mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
          
                Text("Mango-Medium",style: TextStyle( fontSize: 30,fontWeight: FontWeight.bold),),
