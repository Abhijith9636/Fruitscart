...
class fruitdetail2 extends StatefulWidget {
  const fruitdetail2({super.key});

  @override
  State<fruitdetail2> createState() => _fruitdetail2State();
}

class _fruitdetail2State extends State<fruitdetail2> {
  @override
        ...
        child: Padding(
          ...
          child: Column(
           ...
           children: [
            ...
            Image(image: AssetImage("assets2/banana2.png",),height: 300, width: 400,),
          
            Row(
               mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
          
                Text("Banana-Medium",style: TextStyle( fontSize: 35,fontWeight: FontWeight.bold),),
